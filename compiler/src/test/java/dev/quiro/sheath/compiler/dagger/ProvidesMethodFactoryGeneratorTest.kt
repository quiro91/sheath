...
public final class DaggerModule1_ProvideFactoryFactory implements Factory<dev.quiro.sheath.compiler.dagger.Factory> {
  private final DaggerModule1 module;
  ...
  @Override
  public dev.quiro.sheath.compiler.dagger.Factory get() {
  ...
  public static dev.quiro.sheath.compiler.dagger.Factory provideFactory(DaggerModule1 instance) {
