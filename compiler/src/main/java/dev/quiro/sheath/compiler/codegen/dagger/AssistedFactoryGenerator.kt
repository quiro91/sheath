...
import dev.quiro.sheath.compiler.assistedFactoryFqName
...
import dev.quiro.sheath.compiler.codegen.dagger.AssistedFactoryGenerator.AssistedParameterKey.Companion.toKeysList
...
internal class AssistedFactoryGenerator : PrivateCodeGenerator() {
  ...
  private fun generateFactoryClass(
    ...
    val classDescriptor = module
      ...
      ?: throw SheathCompilationException("Couldn't resolve class for PSI element", element = clazz)
    ...
    val function = when (functions.size) {
      0 -> throw SheathCompilationException(
